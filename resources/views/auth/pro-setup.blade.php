...
<select id="f_skill" class="form-select mb-3" required>
    ...
    <optgroup label="Other Professionals">
        ...
        <option value="Security">Security Guard</option>
                    ...
                    <input type="text" id="f_loc" class="form-control mb-3" required>
                </div>
                <div class="col-md-6">
                    <label>Bio</label>
...
function completePro() {
    ...
    fd.append("experience", document.getElementById("f_exp").value);
    ...
    .then(res => res.json())
    .then(data => {
        alert("Registration Complete! Your account is now under review.");
        window.location.href = "/pro/dashboard";
    })
    .catch(err => alert("Error saving profile. Check file sizes."));
}
</script>
@endsection